...
<section class="main-content-section style-8">
	  ...
	  <div class="main-panel">
		  ...
		  <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Generate Row PDF </h3>
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                   <span class="">
						<a href="{{route('home')}}"><i class="mdi mdi-home"></i></a></span><span><i class="mdi mdi-arrow-right"></i> Row PDF Management</span> 
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
					<table id="rowpdflist-table" class="table table-bordered table-striped dt-responsive nowrap" style="width:100%">
							<thead>
								<tr>
									<th>Sample ID</th>
									<th>Print Preview</th>
	...
	<div id="myModal" class="modal fade users-modal" role="dialog">
	  <div class="modal-dialog modal-lg">
		<div class="modal-content">			
			<div class="page-header">
			<h5 class="modal-title req-popup-title">Print Preview</h5>
			  <button type="button" class="close" data-dismiss="modal">&times;</button>        
			</div>
			<div class="modal-body">		
			  <div class="modal-body popp-up-scroll style-scroll">
...
$("#rowpdflist-table").DataTable({
		...
		serverSide: true,
		ajax:{
		   url: "{{ route('rowpdfgenerate.index') }}",
...
$(document).on( "click",'.printpdf', function() {
	$('#load').show();
	var sampleid = $(this).attr('data-sampleid');
	var url = '{{ route("rowpdfgenerate.print") }}';
	// $('#load').show();
	event.preventDefault();
	$.ajax({
		url: url,
