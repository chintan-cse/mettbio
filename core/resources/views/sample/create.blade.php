    ...
    <section class="content">
	  <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row ">
              <div class="col-lg-12">
						<form id="createsample_form" name="createsample" enctype="multipart/form-data" role="form">
						@csrf
						<div class="card">
						  <div class="card-body">												
							<div class="row">
								<div class="col-sm-8 col-12">
									...
									<div class="input-group mb-3">
										<label class="radio-inline">
											<input type="radio" id="nabl" name="nabl_value" value="nabl" checked>NABL
										</label>
										<label class="radio-inline">
											<input type="radio" id="nonnabl" name="nabl_value" value="nonnabl">Non NABL
										</label>
									</div>
								</div>							
							</div>
											...
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="clientname" class="form-control" placeholder="Client Name" required>
													</div>
												</div>
											</div>								
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="contactnumber" class="form-control floatdigit" placeholder="Contact Number" required>
													</div>
												</div>
											</div>									
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="email" autocomplete="off"  name="clientemail" class="form-control" placeholder="Client Email" required>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-8 col-sm-8 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<textarea class="form-control" name="clientaddress"  placeholder="Enter  Address..."required></textarea>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-8 col-sm-8 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="subvendor" class="form-control" placeholder="Subvendor">
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="productname" class="form-control" placeholder="Product Name" required>
													</div>
												</div>
											</div>								
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="productmaterial" class="form-control" placeholder="Product Material" required>
													</div>
												</div>
											</div>									
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="producttype" class="form-control" placeholder="Product Type" required>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="productbatchno" class="form-control" placeholder="Product Batch No" required>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="productheatno" class="form-control" placeholder="Product Heat No" required>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-sm-4 col-12">
												<div class="form-group">											
													<div class="select2-purple">
														...
														<input  type="text" autocomplete="off"  name="productclientname" class="form-control" placeholder="Product Client Name" required>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="card p-2 mb-3 mt-2 row">
								<div class="col-sm-8 col-12">
									...
									<input  type="text" autocomplete="off" class="form-control float-right datepicker" id="reportdate" name="reportdate" autocomplete="off" >
								</div>							
							</div>
								...
								<div class="row datebox-title">
									<div class="col-lg-12 col-12"> 
										<div class="icheck-primary d-inline">
											<input type="checkbox" name="return_status"  class="cls_return_status" id="return_status">
											<label for="return_status">Return</label>
										</div>
									</div>
								</div>
								<div class="row dateaddbox" id="returnbox" style="display:none;">
									
									<div class="col-lg-4 col-12">  
										<div class="icheck-primary d-inline">
											<input type="checkbox" name="same_client_address"  class="same_client_address" id="same_client_address">
									...
									<div class="col-lg-8 col-12">  
										...
										<div class="input-group">
											<textarea class="form-control" name="returnaddress"  placeholder="Enter  Address..."></textarea>
										</div>
									</div>
								</div>
							</div>
...
<script>
$('#createsamplereset').on('click', function () {
	$('#createsample_form').trigger("reset");
});
...
$('#createsample_form').on('submit', function(event){
	$('#load').show();
	$('#createsample').hide();	
	$(".alert-danger").hide();
	$(".alert-success").hide();
