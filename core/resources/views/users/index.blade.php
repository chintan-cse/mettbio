...
<section class="main-content-section style-8">
              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                   <span class="">
						<a href="{{route('home')}}"><i class="mdi mdi-home"></i></a></span><span><i class="mdi mdi-arrow-right"></i> Users</span> 
                  </li>
                </ul>
              </nav>
            </div>
	...
	<div id="myModal" class="modal fade users-modal" role="dialog">
	  <div class="modal-dialog modal-lg">
        ...
        <div class="page-header">
		<h5 class="modal-title req-popup-title">User Detail</h5>
...
//multiple records delete starts
	...
	$(document).on('click', '#multiplerequestdelete', function(){
        ...
        // {
            ...
            if(id.length > 0)
            {
				if(confirm("Are you sure you want change the status of this User?"))
				{
					$.ajax({
						url:"{{ route('ajaxdata.massuserdelete')}}",
						method:"get",
						data:{id:id},
						datatype: 'JSON',
