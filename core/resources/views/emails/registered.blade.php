...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%;" style="border: solid 1px #ccc;">
	...
	<tr style="display: block;">
		<td>Hi <strong style="color: #0d4e61;">{{$company}}</strong></td>
	</tr>
	<tr>
		<td>Welcome to <strong style="color: #0d4e61;">Precision Glass Industries!</strong></td>
	</tr>
	<tr>
		<td>We feel honored to inform you that we have created your profile with us.</td>
	</tr>
	<tr>
		<td>You can now successfully generate quotations for our wide range of glass doors and panels with your login credentials mentioned below-</td>
	</tr>
	<tr>
		<td><strong>Email-id -</strong> <a href="#">{{$email}}</a></td>
	</tr>
	<tr>
