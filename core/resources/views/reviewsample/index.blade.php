	  ...
	  <div class="main-panel">
		  ...
		  <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Final Review Samples </h3>
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                   <span class="">
						<a href="{{route('home')}}"><i class="mdi mdi-home"></i></a></span><span><i class="mdi mdi-arrow-right"></i> Sample Review Management</span> 
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
					<table id="reviewsamplelist-table" class="table table-bordered table-striped dt-responsive nowrap" style="width:100%">
							<thead>
								<tr>
									<th>Sample ID</th>
									<th>Print Preview</th>
...
$(document).on( "click",'.reviewsample', function() {
	$('#load').show();
	var dataid = $(this).attr('data-sampleid');
	var url = '{{ route("reviewsample.show", ":id") }}';
...
$("#reviewsamplelist-table").DataTable({
...
$(document).on( "click",'.finalisedsample', function() {
	$('#load').show();
	var sampleid = $(this).attr('data-sampleid');
	var url = '{{ route("reviewsample.finalised") }}';
	// $('#load').show();
	event.preventDefault();
	$.ajax({
		url: url,
